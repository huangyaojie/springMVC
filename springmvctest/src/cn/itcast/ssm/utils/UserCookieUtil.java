...
public class UserCookieUtil {
	...
	public static void saveCookie(User user, HttpServletResponse response) throws Exception {
		...
		String cookieValueWithMd5 = MD5.md5crypt(user.getUserId()+ ":"+user.getUserName()+ ":"+ user.getUserPsd() + ":" + validTime + ":" + Const.WEBKEY);
		// 将要被保存的完整的Cookie值
		String cookieValue = user.getUserId()+ ":"+user.getUserName() + ":" + validTime +":"+cookieValueWithMd5;
